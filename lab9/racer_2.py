...
class Pit(pygame.sprite.Sprite):  
    def __init__(self):  
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\rrro0\OneDrive\Рабочий стол\pp2\cars\pit.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40, SCREEN_WIDTH - 40), 0)
        self.speedy = SPEED_2
...
while True:
    ...
    if not game_over_flag:
        ...
        for entity in all_sprites:
            if isinstance(entity, Red) or isinstance(entity, Pit):  
                entity.move()

        if pygame.sprite.spritecollideany(P1, enemy_1):
            screen.fill(RED)
        ...
        if pygame.sprite.spritecollide(P1, enemy_2, True):
            collision_count += 1
            if collision_count >= 2:
                ...
                for pit in enemy_2:
                    pit.rect.center = (random.randint(40, SCREEN_WIDTH - 40), 0)
